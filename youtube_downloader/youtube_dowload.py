...
try:
	...
	Downloading modules .... '''.format(e))

	#installing required modules
	try:
		system("pip3 install -r requirements.txt")	#for ubuntu
	except:
		system("pip install -r requirements.txt")	#for windows
...
def get_audio(video):
	...
	for x in video.streams.filter(type ='audio'):
		...
		print("tag : {} || bitrate : {} || size : {} MB ".format(tag,abr,size))
